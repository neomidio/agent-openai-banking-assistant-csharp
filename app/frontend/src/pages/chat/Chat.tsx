...
const Chat = () => {
    ...
    const makeApiRequest = async (questionContext: QuestionContextType) => {
        ...
        try {
            ...
            if (!response.body) {
                throw Error("Sin cuerpo de respuesta");
            }
            if (stream) {
    ...
    const approaches: IChoiceGroupOption[] = [
        {
            ...
            text: "SDK de Azure OpenAI para Java"
        },
        /* Pendiente la implementación de Semantic Kernel Memory en la versión 1.0.0
        {
            key: Approaches.JAVA_SEMANTIC_KERNEL,
            text: "Semantic Kernel en Java - Memoria"
        },*/
        {
            key: Approaches.JAVA_SEMANTIC_KERNEL_PLANNER,
            text: "Semantic Kernel en Java - Orquestación"
        }
    ];
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Chatea con tu asistente personal</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Pregunta lo que necesites sobre tu cuenta bancaria y pagos, o prueba con un ejemplo</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Escribe una pregunta nueva"
                            disabled={isLoading}
                ...
                >
                    ...
                    {(approach === Approaches.JAVA_OPENAI_SDK || approach === Approaches.JAVA_SEMANTIC_KERNEL) && (
                        <TextField
                            ...
                            label="Sobrescribir plantilla del prompt"
                            multiline
                            autoAdjustHeight
                    ...
                    <SpinButton
                        className={styles.chatSettingsSeparator}
                        label="Cantidad de resultados a recuperar:"
                        min={1}
                        max={50}
                    ...
                    <Checkbox
                        ...
                        label="Usar ranking semántico para la búsqueda"
                        onChange={onUseSemanticRankerChange}
                    />
                    <Checkbox
                        className={styles.chatSettingsSeparator}
                        checked={useSemanticCaptions}
                        label="Usar resúmenes contextuales en lugar de documentos completos"
                    ...
                    {useLogin && (
                        <Checkbox
                            ...
                            label="Usar filtro de seguridad OID"
                    ...
                    {useLogin && (
                        <Checkbox
                            ...
                            label="Usar filtro de seguridad por grupos"
                            disabled={!client?.getActiveAccount()}
                    ...
                    {streamAvailable &&
                        <Checkbox
                            ...
                            label="Transmitir respuestas del chat en tiempo real"
